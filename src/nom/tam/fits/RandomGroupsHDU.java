...
public class RandomGroupsHDU extends BasicHDU {
    ...
    static Header manufactureHeader(Data d) throws FitsException {
        ...
        if (d == null) {
            throw new FitsException(
                "Attempt to create null Random Groups data");
        }
        Header h = new Header();
        d.fillHeader(h);
    ...
    static Object[] generateSampleRow(Header h) throws FitsException {
        ...
        sample[0] = ArrayFuncs.newInstance(baseClass,
                                           h.getIntValue("PCOUNT"));
    ...
    public void info() {
        ...
        if (myHeader != null) {
            ...
            System.out.println("     Ngroups:"
                               + myHeader.getIntValue("GCOUNT"));
            System.out.println("     Npar:   "
                               + myHeader.getIntValue("PCOUNT"));
            System.out.println("     BITPIX: "
                               + myHeader.getIntValue("BITPIX"));
            System.out.println("     NAXIS:  "
                               + myHeader.getIntValue("NAXIS"));
        ...
        if ((data == null) || (data.length < 1) || (data[0].length != 2)) {
            ...
            System.out.println(
                "    Parameters: "
                + nom.tam.util.ArrayFuncs.arrayDescription(data[0][0]));
            System.out.println(
                "    Data:"
                + nom.tam.util.ArrayFuncs.arrayDescription(data[0][1]));
        }
    }
}
