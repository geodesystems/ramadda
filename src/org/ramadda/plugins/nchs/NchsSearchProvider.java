...
package org.ramadda.plugins.nchs;
 ...
 *
 */
public class NchsSearchProvider extends SearchProvider {

    /** _more_ */
    private static final String ID = "nchs";


    /** _more_ */
    private static final String URL =
        "http://services.healthindicators.gov/v5/REST.svc/IndicatorDescriptions/${query}/1";
     ...
     */
    public NchsSearchProvider(Repository repository) {
        super(repository, ID, "National Center for Health Statistics");
    }
    ...
    public List<Entry> getEntries(Request request, SearchInfo searchInfo)
        ...
        if ( !obj.has("items")) {
            System.err.println("NCHS SearchProvider: no items field in json:"
                               + json);
