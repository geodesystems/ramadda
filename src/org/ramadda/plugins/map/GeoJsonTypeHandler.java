...
public class GeoJsonTypeHandler extends GenericTypeHandler implements WikiConstants {
    ...
    public void initializeEntryFromForm(Request request, Entry entry,
        ...
        String json = IOUtil.readContents(entry.getResource().toString(),getClass());
    ...
    public boolean addToMap(Request request, Entry entry, MapInfo map)
        ...
        map.addGeoJsonUrl(entry.getName(), url, true, ShapefileOutputHandler.makeMapStyle(request,  entry));
        return false;
    }
