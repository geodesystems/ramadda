...
public class PointRecord4 extends PointRecord1 {
    public static final int ATTR_FIRST = PointRecord1.ATTR_LAST;
    ...
    return (double) ((PointRecord4)record).wavePacketDescriptorIndex;
    }
    public String getStringValue(Record record, RecordField field, VisitInfo visitInfo) {
    return ""+ ((PointRecord4)record).wavePacketDescriptorIndex;
    }
    });
    ...
    public double getValue(Record record, RecordField field, VisitInfo visitInfo) {
    return (double) ((PointRecord4)record).byteOffsetToWaveformData;
    }
    public String getStringValue(Record record, RecordField field, VisitInfo visitInfo) {
    return ""+ ((PointRecord4)record).byteOffsetToWaveformData;
    }
    });
    FIELDS.add(RECORDATTR_WAVEFORMPACKETSIZEINBYTES = new RecordField("waveformPacketSizeInBytes", "waveformPacketSizeInBytes", "", ATTR_WAVEFORMPACKETSIZEINBYTES, "", "int", "int", 0, SEARCHABLE_NO,CHARTABLE_NO));
    RECORDATTR_WAVEFORMPACKETSIZEINBYTES.setValueGetter(new ValueGetter() {
    public double getValue(Record record, RecordField field, VisitInfo visitInfo) {
    return (double) ((PointRecord4)record).waveformPacketSizeInBytes;
    }
    public String getStringValue(Record record, RecordField field, VisitInfo visitInfo) {
    return ""+ ((PointRecord4)record).waveformPacketSizeInBytes;
    }
    });
    ...
    public double getValue(Record record, RecordField field, VisitInfo visitInfo) {
    return (double) ((PointRecord4)record).returnPointWaveformLocation;
    }
    public String getStringValue(Record record, RecordField field, VisitInfo visitInfo) {
    return ""+ ((PointRecord4)record).returnPointWaveformLocation;
    }
    });
    ...
    public double getValue(Record record, RecordField field, VisitInfo visitInfo) {
    return (double) ((PointRecord4)record).Xt;
    }
    public String getStringValue(Record record, RecordField field, VisitInfo visitInfo) {
    return ""+ ((PointRecord4)record).Xt;
    }
    });
    ...
    public double getValue(Record record, RecordField field, VisitInfo visitInfo) {
    return (double) ((PointRecord4)record).Yt;
    }
    public String getStringValue(Record record, RecordField field, VisitInfo visitInfo) {
    return ""+ ((PointRecord4)record).Yt;
    }
    });
    ...
    public double getValue(Record record, RecordField field, VisitInfo visitInfo) {
    return (double) ((PointRecord4)record).Zt;
    }
    public String getStringValue(Record record, RecordField field, VisitInfo visitInfo) {
    return ""+ ((PointRecord4)record).Zt;
    }
    });
    ...
    public  PointRecord4(PointRecord4 that)  {
        super(that);
    ...
    public  PointRecord4(RecordFile file)  {
        super(file);
    }



    public  PointRecord4(RecordFile file, boolean bigEndian)  {
    ...
    public  boolean equals(Object object)  {
        if(!super.equals(object)) {System.err.println("bad super"); return false;} if(!(object instanceof PointRecord4)) return false;
        PointRecord4 that = (PointRecord4 ) object;
    ...
    public ReadStatus read(RecordIO recordIO) throws Exception  {
        ...
        waveformPacketSizeInBytes =  readInt(dis);
    ...
    public void write(RecordIO recordIO) throws IOException  {
        ...
        writeInt(dos, waveformPacketSizeInBytes);
    ...
    public void setWaveformPacketSizeInBytes(int newValue)  {
