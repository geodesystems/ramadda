...
public class FloatLatLonAltRecord extends org.ramadda.data.point.PointRecord {
    ...
    static {
        ...
        FIELDS.add(RECORDATTR_ALT = new RecordField("alt", "alt", "",
                ATTR_ALT, "", "float", "float", 0, SEARCHABLE_NO,
                CHARTABLE_NO));
    ...
    public boolean equals(Object object) {
        ...
        if ( !(object instanceof FloatLatLonAltRecord)) {
            return false;
        }
    ...
    public int doPrintCsv(VisitInfo visitInfo, PrintWriter pw) {
        ...
        myCnt++;
        pw.print(',');
        pw.print(getStringValue(RECORDATTR_ALT, alt));
        myCnt++;
