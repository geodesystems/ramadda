...
public class DoubleLatLonAltRecord extends org.ramadda.data.point.PointRecord {
    ...
    public  boolean equals(Object object)  {
        if(!super.equals(object)) {System.err.println("bad super"); return false;} if(!(object instanceof DoubleLatLonAltRecord)) return false;
