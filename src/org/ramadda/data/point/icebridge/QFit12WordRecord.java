...
public class QFit12WordRecord extends org.ramadda.data.point.icebridge.QfitRecord {
    ...
    public double getValue(BaseRecord record, RecordField field, VisitInfo visitInfo) {
    return (double) ((QFit12WordRecord)record).startSignalStrength;
    }
    public String getStringValue(BaseRecord record, RecordField field, VisitInfo visitInfo) {
    ...
    public double getValue(BaseRecord record, RecordField field, VisitInfo visitInfo) {
    return (double) ((QFit12WordRecord)record).reflectedSignalStrength;
    }
    public String getStringValue(BaseRecord record, RecordField field, VisitInfo visitInfo) {
    return ""+ ((QFit12WordRecord)record).reflectedSignalStrength;
    }
    });
    ...
    FIELDS.add(RECORDATTR_GPSPDOP = new RecordField("gpsPdop", "gpsPdop", "", ATTR_GPSPDOP, "", "int", "int", 0, SEARCHABLE_NO,CHARTABLE_NO));
    ...
    FIELDS.add(RECORDATTR_PULSEWIDTH = new RecordField("pulseWidth", "pulseWidth", "", ATTR_PULSEWIDTH, "", "int", "int", 0, SEARCHABLE_NO,CHARTABLE_NO));
    ...
    public  boolean equals(Object object)  {
        if(!super.equals(object)) {System.err.println("bad super"); return false;} if(!(object instanceof QFit12WordRecord)) return false;
        ...
        if(this.gpsPdop!= that.gpsPdop) {System.err.println("bad gpsPdop");  return false;}
        if(this.pulseWidth!= that.pulseWidth) {System.err.println("bad pulseWidth");  return false;}
    ...
    public double getValue(int attrId)  {
        ...
        if(attrId == ATTR_GPSPDOP) return gpsPdop;
        if(attrId == ATTR_PULSEWIDTH) return pulseWidth;
