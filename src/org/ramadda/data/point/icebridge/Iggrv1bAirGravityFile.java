...
public Iggrv1bAirGravityFile(String filename) throws java.io.IOException {super(filename);}
public Record doMakeRecord(VisitInfo visitInfo) {return new Iggrv1bAirGravityRecord(this);}
