...
public Igbgm2GravityV09File(String filename) throws java.io.IOException {super(filename);}
public Record doMakeRecord(VisitInfo visitInfo) {return new Igbgm2GravityV09Record(this);}
