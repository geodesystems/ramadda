...
public class QFit14WordRecord extends org.ramadda.data.point.icebridge
    ...
    static {
        ...
        RECORDATTR_STARTSIGNALSTRENGTH.setValueGetter(new ValueGetter() {
            public double getValue(Record record, RecordField field,
                                   VisitInfo visitInfo) {
                return (double) ((QFit14WordRecord) record)
                    .startSignalStrength;
            }
            public String getStringValue(Record record, RecordField field,
                                         VisitInfo visitInfo) {
        ...
        RECORDATTR_REFLECTEDSIGNALSTRENGTH.setValueGetter(new ValueGetter() {
            ...
            public String getStringValue(Record record, RecordField field,
                                         VisitInfo visitInfo) {
                return "" + ((QFit14WordRecord) record)
                    .reflectedSignalStrength;
            }
        });
        ...
        FIELDS.add(RECORDATTR_PASSIVESIGNAL =
            new RecordField("passiveSignal", "passiveSignal", "",
                            ATTR_PASSIVESIGNAL, "", "int", "int", 0,
                            SEARCHABLE_NO, CHARTABLE_NO));
        ...
        FIELDS.add(RECORDATTR_PASSIVELATITUDE =
            new RecordField("passiveLatitude", "passiveLatitude", "",
                            ATTR_PASSIVELATITUDE, "", "int", "int", 0,
                            SEARCHABLE_NO, CHARTABLE_NO));
        ...
        FIELDS.add(RECORDATTR_PASSIVELONGITUDE =
            new RecordField("passiveLongitude", "passiveLongitude", "",
                            ATTR_PASSIVELONGITUDE, "", "int", "int", 0,
                            SEARCHABLE_NO, CHARTABLE_NO));
        ...
        FIELDS.add(RECORDATTR_PASSIVEELEVATION =
            new RecordField("passiveElevation", "passiveElevation", "",
                            ATTR_PASSIVEELEVATION, "", "int", "int", 0,
                            SEARCHABLE_NO, CHARTABLE_NO));
    ...
    public boolean equals(Object object) {
        ...
        if ( !(object instanceof QFit14WordRecord)) {
            return false;
        }
        ...
        if (this.passiveSignal != that.passiveSignal) {
            System.err.println("bad passiveSignal");

            return false;
        }
        if (this.passiveLatitude != that.passiveLatitude) {
            System.err.println("bad passiveLatitude");

            return false;
        }
        if (this.passiveLongitude != that.passiveLongitude) {
            System.err.println("bad passiveLongitude");

            return false;
        }
        if (this.passiveElevation != that.passiveElevation) {
            System.err.println("bad passiveElevation");
    ...
    public double getValue(int attrId) {
        ...
        if (attrId == ATTR_PASSIVESIGNAL) {
            return passiveSignal;
        }
        if (attrId == ATTR_PASSIVELATITUDE) {
            return passiveLatitude;
        }
        if (attrId == ATTR_PASSIVELONGITUDE) {
            return passiveLongitude;
        }
        if (attrId == ATTR_PASSIVEELEVATION) {
