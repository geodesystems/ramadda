...
public AtmIceSSNFile(String filename) throws java.io.IOException {super(filename);}
public Record doMakeRecord(VisitInfo visitInfo) {return new AtmIceSSNRecord(this);}
