...
public McordsIrmcr3File(String filename) throws java.io.IOException {super(filename);}
public Record doMakeRecord(VisitInfo visitInfo) {return new McordsIrmcr3Record(this);}
