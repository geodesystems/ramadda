...
public abstract class MyXmlUtil {
    ...
    public static CDATASection makeCDataNode(Document doc, String text,
        ...
        if (andEncode) {
            return doc.createCDATASection(
                MyXmlUtil.encodeBase64(text.getBytes()));
        } else {
    ...
    public static Element findUrlRefNode(Element node, String urlAttr) {
        String url = MyXmlUtil.getAttribute(node, urlAttr, (String) null);
        if (url == null) {
            return node;
        }
        try {
            return getRoot(url, MyXmlUtil.class);
        } catch (Exception exc) {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < args.length; i++) {
            for(int j=0;j<5;j++) {
                ...
                Trace.call1("old way");
                getRoot(args[i], MyXmlUtil.class);
                Trace.call2("old way");
    ...
    private static void format(String f) {
        try {
            ...
            while (true) {
                ...
                buff.append("<![CDATA[MyXmlUtil.COMMENT:" + commentBlock
                            + "]]>");
            }
    ...
    public static String calculateRFC2104HMAC(String data, String key)
        ...
        try {
            ...
            result = MyXmlUtil.encodeBase64(rawHmac);
        } catch (Exception e) {
