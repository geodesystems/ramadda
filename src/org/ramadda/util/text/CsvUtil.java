...
public class CsvUtil {
	...
	new Cmd("-ge", new Label("Greater than/equals"),"Extract rows that pass the expression",
        ...
        new Cmd("-endswith", "Ensure that each column ends with the string",
                new Arg("column","","type","columns"), new Arg("string")),
        new Cmd("-trim", "", new Arg("columns","","type","columns")),
        new Cmd("-convertdate", "", new Arg("column","","type","columns"), "format1", "format2"),
        new Cmd(
	...
	new Cmd("-sort", "", new Arg("column","Column to sort on","type","column")),
