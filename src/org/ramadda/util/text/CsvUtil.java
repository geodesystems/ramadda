...
public class CsvUtil implements CsvCommands {
    ...
    */
    ...
    private static final Cmd[] commands = {
		...
		ARG_LABEL,"Html Table",
			...
			"number"), new Arg(ARG_PATTERN, "Pattern to skip to",
	...
	new Cmd(CMD_CONCAT, "Create a new column from the given columns",
        ...
        new Cmd(CMD_DISSECT, "Make fields based on patterns",
                new Arg(ARG_COLUMN, "", ATTR_TYPE, TYPE_COLUMN), new Arg(ARG_PATTERN,"e.g., \"(field1:.*) (field2:.*) ...\"",ATTR_TYPE,TYPE_PATTERN,"size","80")),
		...
		new Arg(ARG_PATTERN, "", ATTR_TYPE, TYPE_PATTERN), new Arg("template"),
	...
	*/
	...
	new Cmd(CMD_PRINTDELIM, "Print with delimited output", ARG_LABEL, "Delimited Print",new Arg("delimiter","Delimiter - ,|^ etc. Use \"tab\" for tab")),	
		...
		ARG_LABEL,"To XML",
		new Arg("outer tag"),new Arg("inner tag")),
