...
define("ace/mode/ramadda_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/css_highlight_rules","ace/mode/javascript_highlight_rules","ace/mode/xml_highlight_rules"], function(require, exports, module) {
"use strict";
...
exports.RamaddaHighlightRules = RamaddaHighlightRules;
});
...
define("ace/mode/folding/ramadda",["require","exports","module","ace/lib/oop","ace/range","ace/mode/folding/fold_mode"], function(require, exports, module) {
"use strict";
...
(function() {
    let XmlFoldMode = require("./xml").FoldMode;
    this.xmlFoldMode = new XmlFoldMode();
    this.foldingStartMarker = /^(\+| *{{| *<[^/]+).*/;
    this.getFoldWidgetRangeWikiTag = function(session, foldStyle, row) {
	let debug = false;
	let debug2=false;
	...
	if(line.trim().startsWith('{{')) {
	    return this.getFoldWidgetRangeWikiTag(session, foldStyle, row);
	}
...
var Mode = function(options) {
    ...
    this.HighlightRules = RamaddaHighlightRules;
...
(function() {
    ...
    this.$id = "ace/mode/ramadda";
}).call(Mode.prototype);

exports.Mode = Mode;
});                (function() {
                    window.require(["ace/mode/ramadda"], function(m) {
