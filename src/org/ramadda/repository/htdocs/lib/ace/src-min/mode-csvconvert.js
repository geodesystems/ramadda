...
define("ace/mode/csvconvert_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/css_highlight_rules","ace/mode/javascript_highlight_rules","ace/mode/xml_highlight_rules"], function(require, exports, module) {
"use strict";
...
var tagMap = lang.createMap({
    ...
    var CsvconvertHighlightRules = function() {
	...
	if (this.constructor === CsvconvertHighlightRules)
            this.normalizeRules();
    };

oop.inherits(CsvconvertHighlightRules, XmlHighlightRules);

exports.CsvconvertHighlightRules = CsvconvertHighlightRules;
});
...
define("ace/mode/csvconvert",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/text","ace/mode/javascript","ace/mode/css","ace/mode/csvconvert_highlight_rules","ace/mode/behaviour/xml","ace/mode/folding/html","ace/mode/html_completions","ace/worker/worker_client"], function(require, exports, module) {
"use strict";
...
var CsvconvertHighlightRules = require("./csvconvert_highlight_rules").CsvconvertHighlightRules;
...
var Mode = function(options) {
    ...
    this.HighlightRules = CsvconvertHighlightRules;
...
(function() {
    ...
    this.$id = "ace/mode/csvconvert";
}).call(Mode.prototype);

exports.Mode = Mode;
});                (function() {
                    window.require(["ace/mode/csvconvert"], function(m) {
