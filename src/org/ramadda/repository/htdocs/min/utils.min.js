...
attrs.push(STYLE);attrs.push(HU.css("text-align","center","background",ct[i],WIDTH,"100%",HEIGHT,options.height,"min-width","1px"));let label=options.labels?options.labels[idx]:"";if(options.horizontal)
