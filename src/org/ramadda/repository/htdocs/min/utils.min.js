...
console.log("creating Utils");var Utils={pageLoaded:false,loadFunctions:[],addLoadFunction:function(f){Utils.loadFunctions.push(f);},getIcon:function(icon){return ramaddaBaseUrl+"/icons/"+icon;},imports:{},get:function(list,idx,dflt){if(!list)return dflt;if(idx<list.length)return list[idx];return dflt;},rotate:function(cx,cy,x,y,angle,anticlock_wise){if(angle==0){return{x:parseFloat(x),y:parseFloat(y)};}
