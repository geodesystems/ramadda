...
return number_format(n,options.decimals);return this.formatNumberComma(n);};if(options.showRange){if(!options.showColorTableDots){if(args.horizontal)
...
attrs.push(STYLE);attrs.push(HU.css("background",ct[i],"width","100%","height",options.height,"min-width","1px"));if(args.horizontal)
html+=HtmlUtils.td(["data-value",val,"class","display-colortable-slice","style","background:"+ct[i]+";","width","1"],HtmlUtils.div(attrs,""));else
html+=HU.div(["data-value",val,"class","display-colortable-slice",STYLE,HU.css("background",ct[i],WIDTH,args.colorWidthrcolorw)],HtmlUtils.div(attrs,""));}});if(!options.showColorTableDots){if(options.showRange){if(args.horizontal)
html+="<td width=1%>"+formatter(max)+"&nbsp;</td>";else
