...
let dialog=$("#"+id);dialog.show();dialog.draggable();dialog.position({of:target,my:opts.my,at:opts.at,collision:"fit fit"});$("#"+id+"_close").click(function(){dialog.hide();if(opts.callback)opts.callback(dialog);if(opts.remove)dialog.remove();});return dialog;},pre:function(attrs,inner){return this.tag("pre",attrs,inner);},div:function(attrs,inner){return this.tag("div",attrs,inner);},center:function(inner,attrs){return this.tag("center",attrs,inner);},span:function(attrs,inner){return this.tag("span",attrs,inner);},image:function(path,attrs){return"<img "+this.attrs(["src",path,"border","0"])+" "+this.attrs(attrs)+"/>";},table:function(attrs,inner){return HU.tag("table",attrs,inner);},tr:function(attrs,inner){return this.tag("tr",attrs,inner);},css:function(...attrs){let css="";for(let i=0;i<attrs.length;i+=2){css+=attrs[i]+":"+attrs[i+1]+";";}
