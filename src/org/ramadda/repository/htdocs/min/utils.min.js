...
var html=HtmlUtils.openTag("div",divargs);if(!options.showColorTableDots)
html+="<table cellpadding=0 cellspacing=0 width=100% border=0><tr>";let formatter=n=>{if(options.decimals>=0)
