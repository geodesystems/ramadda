...
return css;},h2:function(h){return HU.tag("h2",[],h);},h3:function(h){return HU.tag("h3",[],h);},td:function(attrs,inner){return this.tag("td",attrs,inner);},tds:function(attrs,cols){var html="";for(var i=0;i<cols.length;i++){html+=this.td(attrs,cols[i]);}
