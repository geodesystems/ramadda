...
var Utils={pageLoaded:false,loadFunctions:[],addLoadFunction:function(f){Utils.loadFunctions.push(f);},getIcon:function(icon){return ramaddaBaseUrl+"/icons/"+icon;},imports:{},get:function(list,idx,dflt){if(!list)return dflt;if(idx<list.length)return list[idx];return dflt;},rotate:function(cx,cy,x,y,angle,anticlock_wise=false){if(angle==0){return{x:parseFloat(x),y:parseFloat(y)};}
...
"\t"+
$(this).val().substring(end));this.selectionStart=this.selectionEnd=start+1;}});Utils.loadFunctions.forEach(f=>{f();});},colorToRgb:{"red":"rgb(255,0,0)","green":"rgb(0,255,0)","blue":"rgb(0,0,255)","yellow":"rgb(255,255,0)","aqua":"#00FFFF","black":"#000000","brown":"A52A2A","":"#00FFFF",},pSBC:function(p,c0,c1,l){c0=this.colorToRgb[c0]||c0;c1=this.colorToRgb[c1]||c1;let r,g,b,P,f,t,h,i=parseInt,m=Math.round,a=typeof(c1)=="string";if(typeof(p)!="number"||p<-1||p>1||typeof(c0)!="string"||(c0[0]!='r'&&c0[0]!='#')||(c1&&!a)){return null;}
