...
url+="&ancestor="+encodeURIComponent(settings.ancestor);for(var i=0;i<settings.metadata.length;i++){let metadata=settings.metadata[i];url+="&metadata_attr1_"+metadata.type+"="+metadata.value;}
