...
parent=tmp;}},map:async function(func){var children;await this.getChildrenEntries(l=>{children=l});children.map(func);},getParentEntry:async function(callback,extraArgs){if(!this.parent){return Utils.call(callback,null);}
