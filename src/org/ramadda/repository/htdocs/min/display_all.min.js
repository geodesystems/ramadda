...
var url;var variable;if(tag=="text"||tag=="json"){var args=line.match(/^([a-zA-Z0-9_]+) *= *(.*)$/);if(args){variable=args[1];line=args[2].trim();msgExtra=" (var "+variable+")";}}
...
if(variable){this.notebook.addGlobal(variable,results);}else{if(isJson){results=JSON.stringify(results,null,2);}
