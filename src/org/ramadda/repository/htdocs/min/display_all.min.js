...
this.map.setProgress(HtmlUtils.div([ATTR_CLASS,"display-map-message"],"Loading map..."));setTimeout(()=>{try{this.updateUIInner(pointData,records);}catch(exc){this.map.setProgress(HtmlUtils.div([ATTR_CLASS,"display-map-message"],""+exc));return;}
