...
dataList=newData;var stride=parseInt(this.getProperty("stride",-1));if(stride<0){var maxSize=parseInt(this.getProperty("maxDisplayedPoints",-1));stride=1;if(maxSize>0&&dataList.length>0){while(dataList.length/stride>maxSize){stride++;}}}
