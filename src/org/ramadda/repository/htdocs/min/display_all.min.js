...
console.log("record:"+value.replace(/ /g,"X")+":");recordMap[value]=record;}});var j=0;features.map(feature=>{feature.featureIndex=j++;feature.featureMatched=false;feature.pointCount=0;feature.circles=[];var attrs=feature.attributes;var ok=false;for(var attr in attrs){if(linkFeature==attr){ok=true;var value=this.map.getAttrValue(attrs,attr);var debug=value.indexOf("xxxx0803")>=0;if(debug)
