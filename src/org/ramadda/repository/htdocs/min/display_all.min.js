...
this.map.lines.redraw();this.applyVectorMap(true);},showAllPoints:function(){if(this.lines){for(var i=0;i<this.lines.length;i++){var line=this.lines[i];line.style.display='inline';}
if(this.map.lines)
...
if(showPoints){if(!Utils.isDefined(seen[point]))seen[point]=0;if(seen[point]>500)continue;seen[point]++;var mapPoint=null;if(iconField){var icon=tuple[iconField.getIndex()];var size=iconSize;if(sizeBy.index>=0){size=props.pointRadius*size;}
