...
if(chunk!=""){var div=makeDiv();chunks.push({content:chunk,type:type,props:rest.split(" "),div:div,doChunk:doChunk,ok:true});}
...
this.rawOutput="";for(var i=0;i<chunks.length;i++){var chunk=chunks[i];if(!chunk.doChunk){continue;}
chunk.div.set("");if(doingAll&&chunk.props.indexOf("skipRunAll")>=0)continue;await this.processChunk(chunk);if(!chunk.ok){return false;}}
