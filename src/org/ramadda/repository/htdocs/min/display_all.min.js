...
this.skewt=new D3Skewt(skewtId,options,data);await this.getDisplayEntry((e)=>{var q=e.getAttribute("variables");if(q){q=q.value;q=q.replace(/\n/g,"<br>").replace(/ /g,"&nbsp;");q=HtmlUtils.div(["class","display-skewt-text"],q);$("#"+this.skewt.textBoxId).html(q);}});}});}
