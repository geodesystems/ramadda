...
this.jq(ID_HEADER2).html(HtmlUtils.div(["class","display-filterby"],searchBar));if(!hideFilterWidget){for(var i=0;i<dateIds.length;i++){HtmlUtils.datePickerInit(dateIds[i]);}}
