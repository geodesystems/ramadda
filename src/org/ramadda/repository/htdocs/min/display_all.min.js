...
this.jq(ID_HEADER2).html(header2);var theDisplay=this;dataFilterIds.map(id=>{$("#"+id).click(function(e){inputFunc($(this));});});if(filterBy.length>0){if(!hideFilterWidget){for(var i=0;i<dateIds.length;i++){HtmlUtils.datePickerInit(dateIds[i]);}}
