...
this.output.html(h);this.outputUpdated();},outputUpdated:function(){this.outputHtml=this.jq(ID_OUTPUT).html();},getRawOutput:function(){return this.rawOutput;},focus:function(){this.input.focus();},clearOutput:function(){this.output.html("");this.outputHtml="";},processHtml:async function(blob){this.rawOutput+=blob.blob+"\n";blob.div.set(blob.blob);},processMd:async function(blob){await this.notebook.import(ramaddaBaseUrl+"/lib/showdown.min.js");this.rawOutput+=blob.blob+"\n";var converter=new showdown.Converter();var html=converter.makeHtml(blob.blob);blob.div.set(html);},processPy:async function(blob){await this.notebook.import(ramaddaBaseUrl+"/lib/skulpt.min.js");await this.notebook.import(ramaddaBaseUrl+"/lib/skulpt-stdlib.js");var output="";var outf=function(t){if(t.trim()!=""){output+=t.trim()+"<br>"}}
