...
html+=HtmlUtils.openTag("table",["id",this.getDomId("summary"+col),"table-height","300","class","stripe row-border nowrap ramadda-table"]);html+=HtmlUtils.openTag("thead",[]);html+=HtmlUtils.tr([],HtmlUtils.th([],f.getLabel())+HtmlUtils.th([],"Count"));html+=HtmlUtils.closeTag("thead");html+=HtmlUtils.openTag("tbody",[]);if(!f.isNumeric){s.values.sort((a,b)=>{if(a.count<b.count)return 1;if(a.count>b.count)return-1;return 0;});}
