...
this.jq(ID_HEADER2).html(HtmlUtils.div(["class","display-filterby","style",hideFilterWidget?"display:none;":""],searchBar));if(!hideFilterWidget){for(var i=0;i<dateIds.length;i++){HtmlUtils.datePickerInit(dateIds[i]);}}
