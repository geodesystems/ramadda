...
if(showingHeader)
this.gutter.css("display","none");},applyStyle:function(){this.checkHover(false);this.header.css("display","none");if(this.showInput&&this.notebook.showInput()){this.jq(ID_INPUT_TOOLBAR).css("display","block");this.inputContainer.show("show");}else{this.jq(ID_INPUT_TOOLBAR).css("display","none");this.inputContainer.hide();}
