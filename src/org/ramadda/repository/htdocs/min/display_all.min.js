...
return"null";});records.map((r,i)=>{let row=getId(rowSelector,r,rows);let column=getId(columnSelector,r,columns);let key=row+"-"+column;if(this.checkDataFilters(checkers,r)){if(!this.checked[key])this.checked[key]=[];this.checked[key].push(r);}
