...
var dontAddPoint=this.doDisplayMap();var didColorBy=false;var seen={};for(var i=0;i<points.length;i++){var pointRecord=records[i];var tuple=pointRecord.getData();var point=points[i];if(justOneMarker){if(this.justOneMarker)
...
var showSegments=this.getProperty("showSegments",false);if(showSegments&&latField1&&latField2&&lonField1&&lonField2){var lat1=values[latField1.getIndex()];var lat2=values[latField2.getIndex()];var lon1=values[lonField1.getIndex()];var lon2=values[lonField2.getIndex()];var attrs={};if(props.fillColor)
...
var date=pointRecord.getDate();if(mapPoint){mapPoint.record=pointRecord;mapPoint.hasColorByValue=hasColorByValue;mapPoint.colorByValue=colorByValue;if(date){mapPoint.date=date.getTime();}
