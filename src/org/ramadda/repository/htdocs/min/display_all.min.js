...
url=line;var results=null;await Utils.importText(url,h=>results=h,(jqxhr,settings,err)=>error="Error fetching "+origLine+" error:"+err?err.toString():"");if(results){if(line.startsWith("json:")){results=JSON.parse(results);}
if(v){this.notebook.addGlobal(v,results);}else{if(line.startsWith("json:")){results=JSON.stringify(results,null,4);}
