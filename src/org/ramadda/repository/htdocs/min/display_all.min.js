...
return titleToShow;},handleEventFieldValueSelected:function(source,args){this.setProperty("filterPattern",args.value);this.setProperty("patternFilterField",args.field.getId());this.updateUI();},handleEventPropertyChanged:function(source,prop){if(prop.property=="filterValue"){this.haveCalledUpdateUI=false;var widgetId="filterby_"+prop.fieldId;this.settingFilterValue=true;this.jq(widgetId).val(prop.value);this.settingFilterValue=false;}
...
widget=HtmlUtils.select("",["id",widgetId,"fieldId",filterField.getId()],enums,value);}else if(filterField.isNumeric){var opid=widgetId+"_operator";var operator=this.getProperty(filterField.getId()+".filterOperator","<");widget=HtmlUtils.select("",["id",opid],["<",">","="],operator,);widget+=HtmlUtils.input("",value,["id",widgetId,"size",4,"fieldId",filterField.getId()]);}else{widget=HtmlUtils.input("",value,["id",widgetId,"fieldId",filterField.getId()]);}
...
_this.settingFilterValue=true;_this.updateUI();_this.propagateEvent("handleEventPropertyChanged",{property:"filterValue",fieldId:fieldId,value:value});_this.settingFilterValue=false;});}},updateUI:function(){},getDoBs:function(){if(!(typeof this.dobs==='undefined')){return dobs;}
