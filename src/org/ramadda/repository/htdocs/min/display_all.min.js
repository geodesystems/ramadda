...
dimensions.push(dim);});var trace={type:'parcoords',line:{color:this.getProperty("color",'blue')},dimensions:dimensions,};var data=[trace]
let layout={margin:{l:150,t:50,}};this.setDimensions(layout,2);this.makePlot(data,layout);},});}
