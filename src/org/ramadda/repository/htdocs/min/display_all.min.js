...
if(this.getProperty("doAnimation",false)){var buttons=HtmlUtils.div(["id",this.getDomId(ID_START),"what","run","title","Previous"],HtmlUtils.getIconImage("fa-fast-backward"))+"&nbsp;"+
...
this.applyAnimation();});this.prev.button().click(()=>{if(!this.animation.running)
this.startAnimation(true,true);});this.next.button().click(()=>{if(!this.animation.running)
this.startAnimation(true);});this.showAll.button().click(()=>{this.animation.running=false;this.animation.inAnimation=false;this.animation.label.html("");this.run.html(HtmlUtils.getIconImage("fa-play"));this.showAllPoints();});}
