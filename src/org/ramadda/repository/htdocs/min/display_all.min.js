...
hidePopupObject();var input=$(this);var val=$(this).val().trim();if(val=="")return;var fieldId=$(this).attr("fieldId");var field=fieldMap[fieldId].field;var values=fieldMap[fieldId].values;var items=[];var regexp=new RegExp("("+val+")",'i');for(var i=0;i<values.length;i++){var match=values[i].toString().match(regexp);if(match){items.push([match[1],values[i]]);}
