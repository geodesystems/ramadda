...
this.currentTopRecord=record;}});}},highlightCount:0,handleEventRecordHighlight:function(source,args){this.currentTopRecord=null;let myCount=++this.highlightCount;var id="#"+this.getId()+"-"+args.record.getId();if(this.highlightedElement){this.unhighlightElement(this.highlightedElement);this.highlightedElement=null;}
