...
var html=HtmlUtils.div(["class","display-images-item","title",tooltip,"style","margin:"+margin+"px;"],HtmlUtils.image(img,["width",width])+label);if(this.splitField){var splitOn=row[this.splitField.getIndex()];if(!splits[splitOn]){splits[splitOn]="";splitHeaders.push(splitOn);}
