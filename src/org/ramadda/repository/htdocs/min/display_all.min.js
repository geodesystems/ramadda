...
this.checkSearchBar();this.updateUI();},getFilterId:function(id){return this.getDomId("filterby_"+id);},getHeader2:function(){return"";},initHeader2:function(){},getRequestMacros:function(){let macros=[];if(!this.getProperty("macros",""))return macros;this.getProperty("macros","").split(",").every(macro=>{if(macro=="")return true;let values=null;let enums=this.getProperty("macro."+macro+".values");if(enums){values=[];enums.split(",").every(tok=>{[id,label]=tok.split(":");values.push([id,label||id]);return true;});}
