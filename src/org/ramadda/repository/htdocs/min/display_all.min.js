...
await cmd.proc.call(_this,cmd.line,cmd.toks,cmd.div,cmd.extra);}},processJs:async function(chunk){console.log("processjs");var lines;var topLines=0;try{await this.getCurrentEntry(e=>{current=e});var state=window.notebook;var notebookEntries=this.notebook.getCurrentEntries();for(name in notebookEntries){state.entries[name]=notebookEntries[name].entry;}
