...
widget=HtmlUtils.div(["style","display:inline-block;"],label+": "+widget);searchBar+=widget+(hideFilterWidget?"":"&nbsp;&nbsp;");}
...
this.sortFields=this.getFieldsByIds(fields,this.getProperty("sortFields","",true));var contents="";if(!this.groupByHtml){this.groupByHtml="";if(this.groupByFields.length>0){var options=[["","--"]];this.groupByFields.map(field=>{options.push([field.getId(),field.getLabel()]);});this.groupByHtml=" Group by: ";for(var i=0;i<this.groupByMenus;i++){var selected="";if(i<this.initGrouping.length){selected=this.initGrouping[i].getId();}
