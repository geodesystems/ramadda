...
_this.propagateEvent("handleEventPropertyChanged",args);_this.settingFilterValue=false;};this.jq(ID_FILTERBAR).find(".display-filterby-buttons").each(function(){let parent=$(this);$(this).find(".display-filterby-button").click(function(event){parent.find(".display-filterby-button").removeClass("display-filterby-button-selected");$(this).addClass("display-filterby-button-selected");var value=$(this).attr("value");parent.attr("value",value);$("#"+parent.attr("id")+"_label").html(value==FILTER_ALL?"&nbsp;":value);inputFunc(parent,null,value);});});this.jq(ID_FILTERBAR).find(".display-filter-input").keyup(function(e){var keyCode=e.keyCode||e.which;if(keyCode==13){return;}
