...
if(this.map.circles)
this.map.circles.redraw();this.applyVectorMap(true);},dataFilterChanged:function(){this.vectorMapApplied=false;this.updateUI();if(this.getProperty("centerOnFilterChange",false)){this.map.centerOnMarkers(null,false,false);}},updateUI:function(){SUPER.updateUI.call(this);if(!this.getDisplayReady()){return;}
