...
var bw=perc/maxPercent;var tdb=showBars?HtmlUtils.td(["valign","center","width",barWidth],HtmlUtils.div(["style","background:"+color+";height:10px;width:"+(Math.round(bw*barWidth))+"px"],"")):"";html+=HtmlUtils.tr([],tdv+tdc+tdp+tdb);}
