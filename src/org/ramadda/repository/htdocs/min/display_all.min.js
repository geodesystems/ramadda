...
url=line;console.log("url:"+url);var results=null;await Utils.importText(url,h=>results=h,(jqxhr,settings,err)=>error="Error fetching "+origLine+" error:"+(err?err.toString():""));if(results){if(isJson){results=JSON.parse(results);}
