...
if(this.map.circles)
this.map.circles.redraw();if(didColorBy){if(colorBy.stringMap){console.log("sm:"+colors);var colors=[];colorByValues=[];for(var i in colorBy.stringMap){colorByValues.push(i);colors.push(colorBy.stringMap[i]);}
