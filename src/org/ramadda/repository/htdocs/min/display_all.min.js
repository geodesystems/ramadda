...
this.jq(ID_CELLS).html(html);},log:function(msg,type,from,div){var icon="";var clazz="display-notebook-console-item";if(typeof msg=="object"){msg=Utils.formatJson(msg);}
...
chunk.hasRun=true;for(var i=0;i<chunk.depends.length;i++){var name=chunk.depends[i];if(chunkMap[name]&&!chunkMap[name].hasRun){var ok=true;await this.runChunk(chunkMap[name],chunkMap,false,null,(r=>ok=r));if(!ok)
return Utils.call(callback,false);}}
await this.processChunk(chunk);if(!chunk.ok){return Utils.call(callback,false);}
