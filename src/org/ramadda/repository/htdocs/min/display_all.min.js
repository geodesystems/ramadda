...
var html="";if(!this.groupField)html=groups[""];else{var width=groupHeaders.length==0?"100%":100/groupHeaders.length;html+="<table width=100%><tr valign=top>";for(var i=0;i<groupHeaders.length;i++){var header=groupHeaders[i];var cnt=groupCnt[header]
