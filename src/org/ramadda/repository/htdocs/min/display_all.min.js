...
if(!asHtml)
corpus=HtmlUtils.tag("pre",[],corpus);this.writeHtml(ID_TEXT,corpus);var lines=this.jq(ID_TEXT).find(".display-raw-line");lines.click(function(){var idx=$(this).attr("recordIndex");var record=_this.indexToRecord[idx];if(record)
