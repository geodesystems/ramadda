...
return;}
if(prop.property=="filterValue"){if(!this.getProperty("acceptFilterEvent",true))return;this.haveCalledUpdateUI=false;var widgetId="filterby_"+prop.fieldId;if(prop.id.endsWith("_min"))widgetId+="_min";if(prop.id.endsWith("_max"))widgetId+="_max";this.settingFilterValue=true;this.jq(widgetId).val(prop.value);this.jq(widgetId).attr("value",prop.value);this.settingFilterValue=false;this.dataFilterChanged();return;}
