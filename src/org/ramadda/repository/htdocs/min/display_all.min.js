...
display.notifyEvent(func,source,data);}},getDisplaysToLayout:function(){var result=[];console.log("displays:"+this.displays.length);for(var i=0;i<this.displays.length;i++){if(this.displays[i].getIsLayoutFixed()){console.log("\tisFixed:"+this.displays[i].type);continue;}
console.log("\tno Fixed:"+this.displays[i].type);result.push(this.displays[i]);}
