...
menu+="</select>";var html="";html+=menu;html+=HtmlUtils.openTag("div",["style","max-height:100%;overflow-y:auto;"]);html+="<table>";var tmp=[];for(var rowIdx=1;rowIdx<dataList.length;rowIdx++){tmp.push(dataList[rowIdx]);}
