...
console.log("load data:"+url);Utils.doFetch(url,success,fail,"text");}});}
...
this.plugins[plugin.languageId]=plugin;},hasPlugin:function(id){return this.plugins[id]!=null;},processChunkWithPlugin:async function(id,chunk,callback){var module=this.plugins[id].module;var func=this.plugins[id].evaluator;var result=window[module][func](chunk.content);return Utils.call(callback,result);},processPluginOutput:function(id,chunk,result){if(!result)return;var module=this.plugins[id].module;var func=window[this.plugins[id].outputHandler];if(func){chunk.div.append(func(result));}else{if(typeof result=="object")
chunk.div.set(this.formatObject(result));else
chunk.div.set(result);}},log:function(msg,type,from,div){var icon="";var clazz="display-notebook-console-item";if(typeof msg=="object"){msg=Utils.formatJson(msg);}
