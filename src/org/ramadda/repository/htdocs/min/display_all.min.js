...
return this.getProperty(key,dflt);},initTooltip:function(){},xxxx:'y',formatNumber:function(number){if(isNaN(number)){return"--";}
...
tooltip=`<div style='padding:8px;'>'${tooltip}</div>`;
			...
			newRow.push(value);
                    ...
                    if (j == 0 && props.includeIndex) {
                        //is the index so don't add a tooltip}else{if(addStyle)
newRow.push(color);if(addTooltip)
newRow.push(tooltip);}
