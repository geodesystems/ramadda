...
ok=false;}}else{var startsWith=values[i].startsWith;var _values=values[i]._values;if(values[i].anyValues){ok=false;for(var j=0;j<_values.length;j++){var fv=_values[i];value=(""+value).toLowerCase();if(startsWith){if(value.startsWith(fv)){ok=true;break;}}else if(value.indexOf(fv)>=0){ok=true;break;}}}}}
