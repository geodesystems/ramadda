...
$(this).css("border","1px solid #aaa");_this.haveCalledUpdateUI=false;_this.clipBounds=true;_this.updateUI();});},updateUI:function(){this.lastUpdateTime=null;SUPER.updateUI.call(this);if(!this.getDisplayReady()){return;}
