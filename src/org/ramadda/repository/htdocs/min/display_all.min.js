...
var tuple=[value,label];enumValues.push(tuple);}});enumValues.sort((a,b)=>{return a.get(1).localeString(b.get(1));});for(var i=0;i<enumValues.length;i++)
...
colorBy.range=colorBy.maxValue-colorBy.minValue;if(this.points){for(var i=0;i<this.points.length;i++){this.map.removePoint(this.points[i]);}
this.points=[];}
