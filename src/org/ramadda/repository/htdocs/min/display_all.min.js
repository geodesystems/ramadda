...
for(var i=0;i<s.values.length;i++){var value=s.values[i].value;var label=value;if(label=="")label="&lt;blank&gt;";var count=s.values[i].count;if(count==0)continue;value=value.replace(/\'/g,"&apos;");value=HtmlUtils.span(["title","Click to select","class","display-frequency-value","data-field",s.field.getId(),"data-value",value],label);var tdv=HtmlUtils.td([],value);var tdc=(showCount?HtmlUtils.td(["align","right"],count):"");var perc=count/s.total;var tdp=showPercent?HtmlUtils.td(["align","right"],s.total==0?"0":Math.round(perc*100)+"%"):"";var color=dfltColor;if(colors){if(i<colors.length)
color=colors[i];else
