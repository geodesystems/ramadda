...
this.startAnimation();},getDomId:function(id){return this.display.getDomId(id);},jq:function(id){return this.display.jq(id);},init:function(dateMin,dateMax){this.dateMin=dateMin;this.dateMax=dateMax;this.dateRange=this.dateMax.getTime()-this.dateMin.getTime();this.begin=this.dateMin;this.end=this.dateMin;this.label.html(this.formatAnimationDate(this.dateMin)+" - "+this.formatAnimationDate(this.dateMax));},makeControls:function(){var buttons=HtmlUtils.span(["id",this.getDomId(ID_BEGIN),"title","Go to beginning"],HtmlUtils.getIconImage("fa-fast-backward"))+
