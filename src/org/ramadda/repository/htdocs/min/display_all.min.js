...
var url=line;var results=null;await Utils.importText(url,h=>results=h,(jqxhr,settings,exception)=>error="Error fetching "+origLine+" "+exception);if(results){if(v){window[v]=results;}else{blob.div.append(HtmlUtils.pre([],results));}}}else{blob.div.append("Unknown fetch:"+line);}
