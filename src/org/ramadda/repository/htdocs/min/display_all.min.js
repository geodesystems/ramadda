...
var pointData=this.dataCollection.getList();for(var i=0;i<pointData.length;i++){pointData[i].handleEventMapClick(this,source,args.lon,args.lat);}},handleEventPointDataLoaded:function(source,pointData){this.updateUI();},updateUI:async function(){if(!this.loadedResources){await Utils.importCSS(ramaddaBaseHtdocs+"/lib/skewt/sounding.css");await Utils.importJS(ramaddaBaseUrl+"/htdocs_v_a/lib/skewt/d3skewt.js");this.loadedResources=true;}
