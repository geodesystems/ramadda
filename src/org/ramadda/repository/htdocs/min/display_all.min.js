...
await this.currentEntry.getParentEntry(entry=>{console.log("parent:"+entry.getName());this.parentEntry=entry;});},getCurrentEntry:async function(callback){if(this.currentEntry==null){await this.setCurrentEntry(this.notebook.currentEntry);}
