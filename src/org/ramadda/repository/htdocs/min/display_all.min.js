...
if(colorBy.index>=0){var value=record.getData()[colorBy.index];var color=colorBy.getColor(value,record);if(color){lineAttrs.push("style");lineAttrs.push("background:"+Utils.addAlphaToColor(color,"0.25")+";");}}
line=HtmlUtils.div(lineAttrs,line);if(addLineNumbers){corpus+=HtmlUtils.tr(["valign","top"],HtmlUtils.td(["width","10px"],"<a name=line_"+lineCnt+"></a>"+
