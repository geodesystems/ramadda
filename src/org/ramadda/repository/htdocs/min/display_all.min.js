...
HtmlUtils.td([],t.val1)+
HtmlUtils.td([],t.val2)
+HtmlUtils.td([],t.percent+"%"));});html+=HtmlUtils.closeTag("tbody");html+=HtmlUtils.closeTag("table");this.writeHtml(ID_DISPLAY_CONTENTS,html);HtmlUtils.formatTable("#"+this.getDomId("percentchange"),{});},})}
