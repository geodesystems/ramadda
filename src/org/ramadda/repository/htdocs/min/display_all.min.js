...
return chunk;};var makeDiv=()=>{var div=(divCnt<this.divs.length?this.divs[divCnt]:null);divCnt++;if(div){if(div.jq().length==0){div=null;}else{}}else{}
