...
if(dataList.length>0&&this.getDataValues(dataList[0]).length>1){if(!this.chartOptions.hAxis)this.chartOptions.hAxis={};$.extend(this.chartOptions.hAxis,{title:this.getDataValues(dataList[0])[0]});if(!this.chartOptions.vAxis)this.chartOptions.vAxis={};$.extend(this.chartOptions.vAxis,{title:this.getDataValues(dataList[0])[1]});if(!isNaN(this.getVAxisMinValue())){chartOptions.hAxis.minValue=this.getVAxisMinValue();chartOptions.vAxis.minValue=this.getVAxisMinValue();}
