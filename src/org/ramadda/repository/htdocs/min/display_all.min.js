...
var html=this.getRecordHtml(pointRecord,fields);if(polygonField){var toks=values[polygonField.getIndex()].split(";");var p=[];for(var pIdx=0;pIdx<toks.length;pIdx+=2){var lat=parseFloat(toks[pIdx]);var lon=parseFloat(toks[pIdx+1]);p.push(new OpenLayers.Geometry.Point(lon,lat));}
