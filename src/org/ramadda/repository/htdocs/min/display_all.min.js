...
if(ok){total+=data[j];}}
if(total!=0){percent=percent=value/total*100;percent=(percent-this.minValue)/(this.maxValue-this.minValue);}}else{var v=value;if(this.isString){v=this.colorByMap[v];if(v)return v;}
...
if(v==dfltValue)extra=" display-filterby-button-selected ";if(useImage){var image=enums[j].image;if(image){buttons+=HtmlUtils.div(["class","display-filterby-button display-filterby-button-image"+extra,"value",v,"title",label],HtmlUtils.image(enums[j].image,imageAttrs));}else{buttons+=HtmlUtils.div(["class","display-filterby-button display-filterby-button-image"+extra,"value",v,"title",label],label);}}else{buttons+=HtmlUtils.div(["class","display-filterby-button  display-filterby-button-image"+extra,"value",v],label);}}
