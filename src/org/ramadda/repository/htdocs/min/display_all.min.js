...
if(!haveGoogleChartsLoaded()){if(!this.googleChartCallbackPending){this.googleChartCallbackPending=true;var func=function(){_this.googleChartCallbackPending=false;console.log(_this.type+" google charts loaded");_this.displayData();}
...
var c1=this.jq(ID_CHART);if(c1.length==0){console.log("no div");console.trace();this.bad=true;return;}
if(this.bad)return;this.chart=this.doMakeGoogleChart(dataList,props,selectedFields,this.chartOptions);if(this.chart!=null){var dataTable=this.makeDataTable(dataList,props,selectedFields);if(!dataTable){this.setContents(this.getMessage("No data available"));return;}
