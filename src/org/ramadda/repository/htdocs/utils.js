...
//		console.trace();
    ...
    rangeInputInit: function(id) {
        ...
        $("input.sliderValue").change(function() {
            var $this = $(this);
            jqid('slider').slider("values", $this.data("index"), $this.val());
        });
    },
