...
public class Admin extends RepositoryManager {
	...
	*/
	...
	if(!doIt) {
	    ...
	    sb.append(getAuthManager().getVerificationWithPassword(request,null));
	...
	****/
	...
	formSB.append(getAuthManager().getVerificationWithPassword(request,
						       "For verification enter your password. Be very careful what you do here! This evaluates arbitrary SQL and you can really screw up your RAMADDA if you do something wrong here."));
        formSB.append(HU.br());
	...
	topSB.append(getAuthManager().getVerificationWithPassword(request,null));
	topSB.append(HU.formClose());
	...
	sb.append(HU.center(HU.makeHeader2(links)));
		...
		sb.append(getAuthManager().getVerificationWithPassword(request,"To verify shutdown please enter your password"));
                sb.append(HU.formClose());
            }
