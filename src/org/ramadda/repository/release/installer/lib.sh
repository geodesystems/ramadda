...
export RAMADDA_INSTALL_DIR=${PARENT_DIR}/${SERVICE_NAME}
export SERVER_DIR=$RAMADDA_INSTALL_DIR/ramaddaserver
export SERVICE_SCRIPT=${SERVER_DIR}/ramaddaService.sh
