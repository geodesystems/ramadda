...
public class WikiTags implements  OutputConstants,WikiConstants,Constants {
    ...
    public static final WikiTagCategory[] WIKITAGS = {
        ...
        new WikiTagCategory("Layout", 
					...
					"#entriesListInMap","true","entriesListHeader",""), 
        ...
        new WikiTagCategory("Images & Dates",
                            new WikiTag(WIKI_TAG_IMAGE,null,
                                        "#"+ATTR_SRC, "", ATTR_WIDTH,"100%", "#width","screenshot",
        ...
        new WikiTagCategory("Misc 1",
					...
					"#lightColor","blue"),
                            ...
                            new WikiTag(WIKI_TAG_PROPERTIES, null, "message","","metadata.types","",ATTR_METADATA_INCLUDE_TITLE,"true","separator","","decorate","false","inherited","false"),
                            new WikiTag(WIKI_TAG_DISPLAYPROPERTIES, null, "displayType","null"),


                            new WikiTag(WIKI_TAG_LICENSE, "Content License",
					"license","cc-by",
					"includeName","true",
					...
					"#requireId", "If set then user must agree. Some unique id, e.g., agreed_license_1",
