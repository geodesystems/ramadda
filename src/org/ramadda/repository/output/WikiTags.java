...
public class WikiTags implements  OutputConstants,WikiConstants,Constants {
    ...
    public static final WikiTagCategory[] WIKITAGS = {
        new WikiTagCategory("Information",
					...
					"#showMetadata","false",
					"#menus","file,edit,view,feeds,other,service","#menusTitle","Services"),
        ...
        new WikiTagCategory("Display",
					...
					"label","listen","#url","","#start","0"), 
                            new WikiTag(WIKI_TAG_ENTRYLINK,"Entry link", ATTR_TT,"Link to entry","link","",
					ATTR_TITLE,"",ATTR_SHOWICON,"true",
					"#icon","fas fa-plus",
					"#makeButton","true","#action",""), 			    
        ...
        new WikiTagCategory("Images & Dates",
					...
					"#showLink","true",
					"#slidesStyle","border:1px solid #efefef;"),
        ...
        new WikiTagCategory("Misc 1",
					...
					"threshold","0"), 
                            new WikiTag(WIKI_TAG_TAGCLOUD, null,
					"type", "metadata type",
					...
					ATTR_TT,"Show the data status metadata if it exists"),
