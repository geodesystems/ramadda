...
public class WikiManager extends RepositoryManager implements WikiConstants,
    ...
    public static final WikiTagCategory[] WIKITAGS = {
        ...
        new WikiTagCategory("Displays",
					...
					ATTR_WIDTH, "800",
                            ...
                            new WikiTag(WIKI_TAG_DISPLAY, "Map",
                                        ...
                                        ATTR_WIDTH, "100%",
                                        ATTR_HEIGHT, "400"),
			    new WikiTag(WIKI_TAG_DISPLAY, "Map Grid",
                                        ATTR_TYPE, "mapgrid", 
					...
					"popupTemplate","${default}"
                            ...
                            new WikiTag(WIKI_TAG_DISPLAY,
                                        "Records",
                                        ATTR_TYPE, "records", "maxHeight", "400px"),
                            new WikiTag(WIKI_TAG_DISPLAY,
                                        "Notebook",
                                        ATTR_TYPE, "notebook",
                                        "#runOnLoad","true",
        ...
        new WikiTagCategory("Charts",
                            new WikiTag(WIKI_TAG_DISPLAY, "Line chart",
                                        ATTR_TYPE, "linechart", "#" +ATTR_WIDTH, "800",
					"#" +ATTR_HEIGHT, "400"),
                            new WikiTag(WIKI_TAG_DISPLAY, "Bar chart",
                                        ATTR_TYPE, "barchart"),
                            new WikiTag(WIKI_TAG_DISPLAY, "Area chart",
                                        ATTR_TYPE, "areachart"),
                            new WikiTag(WIKI_TAG_DISPLAY,
                                        "Scatter Plot",
                                        ATTR_TYPE, "scatterplot"),
                            new WikiTag(WIKI_TAG_DISPLAY,
                                        "Histogram",
                                        ATTR_TYPE, "histogram"),
                            new WikiTag(WIKI_TAG_DISPLAY,
	...
	new WikiTagCategory("Misc Charts",
			    new WikiTag(WIKI_TAG_DISPLAY, "Cards",
					ATTR_TYPE, "cards"), 
                            new WikiTag(WIKI_TAG_DISPLAY,
                                        "Blank",
                                        ATTR_TYPE, "blank"),
			    ...
			    new WikiTag(WIKI_TAG_DISPLAY,
                                        "Percent Change",
                                        ATTR_TYPE, "percentchange"),
			    new WikiTag(WIKI_TAG_DISPLAY,
					"Time Range chart",
					ATTR_TYPE, "timerangechart", 
