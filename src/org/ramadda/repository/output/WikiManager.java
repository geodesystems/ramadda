...
public class WikiManager extends RepositoryManager
    ...
    public String getWikiPropertyValue(WikiUtil wikiUtil, String property,
		...
		if(primaryEntry==null) primaryEntry=(Entry) request.getExtraProperty(PROP_CURRENT_ENTRY);
	...
	*/
	...
	BiFunction<String,String,String> makeButton = (title,contents)->{
        ...
        Utils.appendAll(tags2,
			...
			l.call("Menu", "+menu #width=30px #menuDown=true #noBorder=true #noIcon=true_nl_    :menuheader Header_nl_    :menuitem Item 1_nl_    +menu <cog> Menu 1_nl_        :menuitem Item 2_nl_        +menuitem _qt_ _nl_        Menu contents_nl_        -menuitem_nl_    -menu_nl_    +menu <bars> Menu 2_nl_        :menuitem Item 3_nl_    -menu_nl_-menu", ""),
	...
	if(getLLMManager().isLLMEnabled()) {
	    etcLinks.add(HU.href("#", "Edit with LLM",
	...
	buttons.append(HU.span(HU.img(getIconUrl("fas fa-pen-to-square")),
			       HU.attrs("style","margin-left:6px;","title","Edit mode - click in tag to show editor", "class","wiki-editor-menu-icon ramadda-clickable","id", textAreaId + "_toolbar_edit")));
