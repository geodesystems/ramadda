...
public class CsvOutputHandler extends OutputHandler {
	...
	if(what.equals("ids")) {
	    ...
	    mime = "application/x-sh";
	} else if(what.equals("generated_r")) {
	    mime = "text/x-r";
	    request.setReturnFilename("ramadda_download.r");	    
	}
	...
	for(Entry entry: entries) {
		...
		sb.append("\n");
	    } else  if(what.equals("wget") || what.equals("csvapi") || what.equals("generated_r")) {
		if(what.equals("wget")) {
		    if(!entry.isFile()) {
