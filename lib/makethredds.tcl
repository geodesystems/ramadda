...
set skips [list .*log4.* jfree  jdom jcommon unidatacommon slf4j 52 json waterml c3p0 aws-java je-4 Saxon jackson jna- xmlbeans httpmime Hikari SGT Saxon aws c3p0 commons-fileupload commons-codec commons-io commons-lang  d4 failureaccess hibernate-validator jackson jaxen jboss jcip jcl  jmespath jsi- json quartz  taglibs validation waterml xmlbeans spring-webmvc checker-qual]
